...
// к элементу которому нужно задать 100VH помимо height: 100% задать height: calc(var(--vh, 1vh) * 100);
...
/*
Модуль паралакса
data-prlx-mouse элементу
data-prlx-cx=коэффициент_х (значение по умолчанию 100) — управление процентом смещения по оси X
data-prlx-cy=коэффициент_y (значение по умолчанию 100) — управление процентом смещения по оси Y
data-prlx-a=скорость анимации (значение по умолчанию 50) — управление скоростью анимации
data-prlx-dxr – движение в противоположном направлении по оси X
data-prlx-dxy - движение в противоположном направлении по оси Y
*/
